...
def get_network_old(name, batch_size, dtype, input_name):
...
def tune_and_evaluate(tuning_opt, batch_size, dtype, model_name, log_file, graph_opt_sch_file, input_name):
    # extract workloads from relay program
    print("Extract tasks...")
    mod, params, data_shape, out_shape = get_network(model_name, batch_size, dtype, input_name)
...
def main(model_names):
    ...
    for model_name in model_names:
        ...
        tune_and_evaluate(tuning_option, batch_size, dtype, model_name, log_file, graph_opt_sch_file, input_name)
